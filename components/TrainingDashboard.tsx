...
import { CalibrationLog, UserStats, AIEvolutionStats } from '../types';
import { getGrowthInsightAnalysis } from '../services/guideService';
import { getUserStats, getAssessmentFeedback, calculateAIEvolution } from '../services/gamificationService';
...
const SeedlingBadge = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <circle cx="32" cy="32" r="30" className="fill-emerald-50 dark:fill-emerald-900/20" stroke="currentColor" strokeWidth="1.5"/>
    <path d="M32 52V28" className="stroke-emerald-600 dark:stroke-emerald-400" strokeWidth="2.5" strokeLinecap="round"/>
    <path d="M32 42C32 42 20 40 20 28C20 20 32 20 32 20" className="stroke-emerald-600 dark:stroke-emerald-400" strokeWidth="2.5" strokeLinecap="round" fill="none"/>
    <path d="M32 36C32 36 44 34 44 24C44 18 32 18 32 18" className="stroke-emerald-500 dark:stroke-emerald-300" strokeWidth="2.5" strokeLinecap="round" fill="none"/>
  </svg>
);

const QuillBadge = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <circle cx="32" cy="32" r="30" className="fill-blue-50 dark:fill-blue-900/20" stroke="currentColor" strokeWidth="1.5"/>
    <path d="M46 16C46 16 28 36 26 42C24 48 22 52 22 52C22 52 28 48 32 44C36 40 46 16 46 16Z" className="stroke-blue-600 dark:stroke-blue-400" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
...
const CompassBadge = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <circle cx="32" cy="32" r="30" className="fill-indigo-50 dark:fill-indigo-900/20" stroke="currentColor" strokeWidth="1.5"/>
    <circle cx="32" cy="32" r="16" className="stroke-indigo-600 dark:stroke-indigo-400" strokeWidth="2"/>
    <path d="M32 16V24M32 40V48M16 32H24M40 32H48" className="stroke-indigo-400 dark:stroke-indigo-500" strokeWidth="2" strokeLinecap="round"/>
...
const LanternBadge = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <circle cx="32" cy="32" r="30" className="fill-amber-50 dark:fill-amber-900/20" stroke="currentColor" strokeWidth="1.5"/>
    <path d="M24 24H40L44 46H20L24 24Z" className="stroke-amber-600 dark:stroke-amber-400" strokeWidth="2" strokeLinejoin="round"/>
    <path d="M32 24V16M32 16C36 16 38 18 38 20" className="stroke-amber-600 dark:stroke-amber-400" strokeWidth="2" strokeLinecap="round"/>
    <path d="M32 28V42" className="stroke-amber-400 dark:stroke-amber-300" strokeWidth="2" strokeLinecap="round"/>
    <circle cx="32" cy="35" r="4" className="fill-amber-300 dark:fill-amber-200" filter="blur(2px)"/>
  </svg>
);

const GemBadge = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <circle cx="32" cy="32" r="30" className="fill-violet-50 dark:fill-violet-900/20" stroke="currentColor" strokeWidth="1.5"/>
    <path d="M20 28L32 18L44 28L32 50L20 28Z" className="stroke-violet-600 dark:stroke-violet-400" strokeWidth="2" strokeLinejoin="round"/>
    ...
    <path d="M26 28L32 50L38 28" className="stroke-violet-400 dark:stroke-violet-500" strokeWidth="1"/>
  </svg>
);

const TrophyBadge = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <circle cx="32" cy="32" r="30" className="fill-yellow-50 dark:fill-yellow-900/20" stroke="currentColor" strokeWidth="1.5"/>
    <path d="M22 20H42V30C42 38 36 42 32 42C28 42 22 38 22 30V20Z" className="stroke-yellow-600 dark:stroke-yellow-400" strokeWidth="2" strokeLinejoin="round"/>
    <path d="M42 24H48C50 24 50 30 48 32H42" className="stroke-yellow-600 dark:stroke-yellow-400" strokeWidth="2" strokeLinecap="round"/>
    <path d="M22 24H16C14 24 14 30 16 32H22" className="stroke-yellow-600 dark:stroke-yellow-400" strokeWidth="2" strokeLinecap="round"/>
    <path d="M32 42V50M26 50H38" className="stroke-yellow-600 dark:stroke-yellow-400" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);

const CrownBadge = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <circle cx="32" cy="32" r="30" className="fill-rose-50 dark:fill-rose-900/20" stroke="currentColor" strokeWidth="1.5"/>
    <path d="M18 42H46L48 26L38 32L32 18L26 32L16 26L18 42Z" className="stroke-rose-600 dark:stroke-rose-400" strokeWidth="2" strokeLinejoin="round"/>
...
const dashboardSanitizeOptions: DOMPurifyConfig = { ALLOWED_TAGS: ['span', 'br'], ALLOWED_ATTR: ['class'] };
...
const renderHighlightedText = (text: string, phrases: string[]) => {
  ...
  const sanitizedContent = DOMPurify.sanitize(content.replace(/\n/g, '<br />'), dashboardSanitizeOptions);

  return <div dangerouslySetInnerHTML={{ __html: sanitizedContent }} />;
};

const GrowthInsight: React.FC<{ log: CalibrationLog; apiProvider: string; }> = ({ log, apiProvider }) => {
    ...
    return (
        <div className="mt-3 pt-3 border-t border-slate-50 dark:border-slate-700/50">
            ...
            >
               <span className={`w-1.5 h-1.5 rounded-full bg-indigo-500 transition-transform ${isOpen ? 'scale-125' : ''}`}></span>
            ...
            {isOpen && (
                <div className="mt-2 p-3 bg-indigo-50/40 dark:bg-indigo-900/10 rounded-lg border border-indigo-100/50 dark:border-indigo-800/30 animate-fade-in">
                    {isLoading ? (
                        ...
                        <p className="text-[12px] text-indigo-900 dark:text-indigo-200 leading-relaxed font-medium text-justify">
                            {insight}
                        </p>
                    )}
                </div>
    ...
    return (
        <div className="relative h-10 w-full bg-cyan-50/20 dark:bg-cyan-900/5 rounded-lg overflow-hidden">
            <svg viewBox={`0 0 ${width} ${height}`} preserveAspectRatio="none" className="w-full h-full overflow-visible">
                ...
                <path d={`M${points}`} fill="none" className="stroke-cyan-500 dark:stroke-cyan-400" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        </div>
    );
}

const CompactLogCard: React.FC<{ log: CalibrationLog; apiProvider: string }> = ({ log, apiProvider }) => {
    return (
        <div className="bg-white dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700/60 rounded-xl p-4 hover:shadow-md hover:border-indigo-200 dark:hover:border-indigo-800 transition-all duration-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                    <div className="text-[10px] font-bold text-emerald-500 uppercase tracking-wider flex items-center gap-1.5">
                        <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse"></div> 专家校准
                    </div>
...
export const TrainingDashboard: React.FC<TrainingDashboardProps> = ({ logs, onClearLogs, apiProvider }) => {
  ...
  const Badge = getBadgeComponent(stats.level.currentLevel);
      ...
      <div className="grid grid-cols-12 gap-4 mb-5">
        ...
        <div className="col-span-12 sm:col-span-8 bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm p-5 flex items-center gap-5 relative overflow-hidden group">
            ...
            <div className="relative flex-shrink-0 w-16 h-16 rounded-2xl bg-slate-50 dark:bg-slate-700/50 flex items-center justify-center text-slate-300 dark:text-slate-500 ring-1 ring-slate-100 dark:ring-slate-600 shadow-inner">
                <Badge className="w-10 h-10 drop-shadow-sm" />
            ...
            <div className="flex-1 min-w-0 z-10">
                ...
                <div className="space-y-1.5">
                     <div className="flex justify-between text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                        ...
                        <span className="text-indigo-500 tabular-nums">{stats.level.currentXp} / {stats.level.nextLevelXp} XP</span>
                     </div>
        ...
        <div className="col-span-6 sm:col-span-2 bg-white dark:bg-slate-800 rounded-2xl p-4 flex flex-col justify-center items-center border border-slate-100 dark:border-slate-700 shadow-sm hover:border-indigo-200 dark:hover:border-indigo-700 transition-colors">
            ...
            <div className="text-2xl font-black text-indigo-600 dark:text-indigo-400">{stats.totalObservations}</div>
        </div>
        <div className="col-span-6 sm:col-span-2 bg-white dark:bg-slate-800 rounded-2xl p-4 flex flex-col justify-center items-center border border-slate-100 dark:border-slate-700 shadow-sm hover:border-amber-200 dark:hover:border-amber-700 transition-colors">
            ...
            <div className="text-2xl font-black text-amber-500 dark:text-amber-400">{stats.streakDays}<span className="text-xs ml-0.5 text-slate-400 font-bold">天</span></div>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm p-1 flex flex-col relative overflow-hidden">
             ...
             <div className="p-4 flex justify-between items-start">
                 ...
                 {stats.totalObservations < 5 && (
                     <span className="text-[9px] bg-indigo-50 text-indigo-600 px-1.5 py-0.5 rounded border border-indigo-100">新手保护中</span>
                 )}
             </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm p-5 flex flex-col">
             <div className="flex justify-between items-center mb-6">
                ...
                <div className="text-right">
                     <div className="text-2xl font-black text-cyan-600 dark:text-cyan-400 leading-none">{aiStats.averageSyncScore}%</div>
             ...
             <div className="space-y-6">
                <div className="bg-cyan-50/20 dark:bg-cyan-900/5 rounded-xl p-3 border border-cyan-100/50 dark:border-cyan-800/20">
                     <div className="text-[10px] font-bold text-slate-400 mb-2 uppercase tracking-wider">近期同频趋势</div>
                     ...
                     <div className="space-y-2">
                        {aiStats.domainMastery.slice(0, 3).map((d, i) => (
                             <div key={d.domain} className="flex items-center gap-3">
                                <span className="text-[11px] font-bold text-slate-600 dark:text-slate-300 w-16 truncate text-right">{d.domain}</span>
                                ...
                                <span className="text-[10px] font-mono text-slate-400 w-6 text-right">{d.level}</span>
                             </div>
                        ))}
                        {aiStats.domainMastery.length === 0 && <div className="text-[11px] text-slate-400 text-center py-2">暂无足够数据</div>}
                     </div>
                </div>
             </div>
        </div>
      ...
      <div>
           <div className="flex items-center justify-between mb-4 px-1">
                <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
                 档案记录
                 <span className="px-2 py-0.5 bg-slate-100 dark:bg-slate-700 text-slate-500 text-[10px] rounded-full">{logs.length}</span>
                </h3>
            ...
            <div className="space-y-3">
                ...
                {logs.map(log => (
                    <CompactLogCard key={log.id} log={log} apiProvider={apiProvider} />
                ))}
            </div>
      </div>
    </div>
