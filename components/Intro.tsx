        ...
        <div className="text-center my-16 animate-fade-in-up">
            ...
            <h2 className="text-4xl sm:text-5xl font-extrabold text-slate-800 dark:text-white mb-6 tracking-tight font-['Nunito']">
                ...
                <span className="relative whitespace-nowrap">
                    <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-600 to-violet-600 dark:from-indigo-400 dark:via-purple-400 dark:to-violet-400">循证成长</span>
