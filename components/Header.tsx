...
const SettingsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" {...props}>
        ...
        <line x1="5" y1="6" x2="9" y2="6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" opacity="0.7" />
        <line x1="15" y1="6" x2="19" y2="6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" opacity="0.7" />
        <line x1="5" y1="12" x2="9" y2="12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" opacity="0.7" />
        <line x1="15" y1="12" x2="19" y2="12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" opacity="0.7" />
        <line x1="5" y1="18" x2="9" y2="18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" opacity="0.7" />
        <line x1="15" y1="18" x2="19" y2="18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" opacity="0.7" />
    </svg>
);
...
export const Header: React.FC<HeaderProps> = ({ theme, toggleTheme, onToggleDashboard, showDashboard, onToggleSettings }) => {
    return (
        <header className="sticky top-0 z-50 w-full backdrop-blur-xl bg-white/70 dark:bg-slate-900/70 border-b border-slate-200/50 dark:border-slate-800/50 transition-all duration-300 supports-[backdrop-filter]:bg-white/50">
            <div className="container mx-auto px-4 sm:px-6 h-16 flex justify-between items-center max-w-5xl">
                <div className="flex items-center gap-3 group cursor-pointer select-none" onClick={() => window.location.reload()}>
                    ...
                    <h1 className="text-xl font-extrabold text-slate-800 dark:text-white tracking-tight font-['Nunito']">
                        Ai<span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-600 dark:from-indigo-400 dark:to-violet-400">助教</span>
                    </h1>
                </div>
                ...
                <div className="flex items-center gap-2 bg-white/50 dark:bg-slate-800/50 p-1.5 rounded-full border border-slate-200/60 dark:border-slate-700/60 shadow-sm backdrop-blur-md">
                    <button
                        ...
                        title="成长看板"
                    >
                        {showDashboard ? <CloseIcon className="w-5 h-5" /> : <DashboardIcon className="w-5 h-5" />}
                    </button>
                    <button
