...
export const LearningStoryModal: React.FC<LearningStoryModalProps> = ({
  isOpen,
  onClose,
  content,
  isLoading,
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-stone-100 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-stone-800 dark:text-slate-100 font-['Noto_Sans_SC']">
                学习故事
              </h2>
              <p className="text-[10px] text-stone-400 dark:text-slate-500 uppercase tracking-wider font-bold">
                Learning Story
              </p>
            </div>
          </div>
          <button
            onClick={onClose}
            className="p-2 text-stone-400 hover:bg-stone-100 dark:hover:bg-slate-800 rounded-full transition-colors"
          >
